...
find_hot_node(Stmt * stmt)
{
	...
	case STMT_TRY_FINALLY:
	    ...
	    if (find_hot_node(stmt->s.finally.handler))
			return 1;
 	    break;
 	case STMT_SCATFOR: // Scattered for (version 2.1h)
...
char rcsid_decompile[] = "$Id: decompile.c,v 1.1 2002/02/22 19:17:12 bytenik Exp $";

/* 
 * $Log: decompile.c,v $
 * Revision 1.1  2002/02/22 19:17:12  bytenik
 * Initial revision
 *
