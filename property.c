...
char rcsid_property[] = "$Id: property.c,v 1.1 2002/02/22 19:17:54 bytenik Exp $";

/* 
 * $Log: property.c,v $
 * Revision 1.1  2002/02/22 19:17:54  bytenik
 * Initial revision
 *
