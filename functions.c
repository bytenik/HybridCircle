...
char rcsid_functions[] = "$Id: functions.c,v 1.1 2002/02/22 19:17:26 bytenik Exp $";

/* 
 * $Log: functions.c,v $
 * Revision 1.1  2002/02/22 19:17:26  bytenik
 * Initial revision
 *
 * Revision 1.2  2001/01/28 23:48:10  bytenik
